		...
		<div class="panel panel-default qna-list">
			        ...
			        <li>
			            <div class="wrap">
			                <strong class="subject">
								<a href="${pageContext.request.contextPath}/qna/show?questionId=${question.id}">${question.title}</a>
			                </strong>
                            <div class="auth-info">
			...
			<div class="row">
				...
				<div class="col-md-3 qna-write">
					<a href="${pageContext.request.contextPath}/qna/createForm" class="btn btn-primary pull-right" role="button">질문하기</a>
				</div>
			</div>
		</div>
	</div>
